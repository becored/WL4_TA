// @Description TimeAttack_Sub_803B75C_EntityAI_0x2C_Tmain_zako_big_marumen
...
#define Sub_803B75C_EntityAI_0x2C_Tmain_zako_big_marumen ((void (*)()) 0x803B75D)
#define EntityCollision ((int (*)(int, int)) 0x8026211)

#define sin_cos_table ((signed short*) 0x8095138)

void TimeAttack_Sub_803B75C_EntityAI_0x2C_Tmain_zako_big_marumen() {
    // Custom code
