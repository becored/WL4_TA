// @Description TimeAttack_Sub_805DCEC_EntityAI_0x76_Tmain_furawana_uekibachi
// @HookAddress 0x78E9D8
// @HookString P
// Made by beco
// Verison 1.0
...
void TimeAttack_Sub_805DCEC_EntityAI_0x76_Tmain_furawana_uekibachi() {
    // Custom code
