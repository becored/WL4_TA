// @Description TimeAttack_Sub_802B190_EntityAI_0xB3_Tmain_docodoor_wario_in
// @HookAddress 0x78EACC
// @HookString P
// Made by beco
// Verison 1.0
...
#define Sub_802B190_EntityAI_0xB3_Tmain_docodoor_wario_in ((void (*)()) 0x802B191)
#define EntityCollision ((int (*)(int, int)) 0x8026211)

#define sin_cos_table ((signed short*) 0x8095138)

void TimeAttack_Sub_802B190_EntityAI_0xB3_Tmain_docodoor_wario_in() {
    // Custom code
    ...
    // Vanilla code
    Sub_802B190_EntityAI_0xB3_Tmain_docodoor_wario_in();
}
