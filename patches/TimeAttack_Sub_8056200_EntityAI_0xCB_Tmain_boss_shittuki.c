// @Description TimeAttack_Sub_8056200_EntityAI_0xCB_Tmain_boss_shittuki
// @HookAddress 0x78EB2C
// @HookString P
// @EntryFunctionSymbol TimeAttack_Sub_8056200_EntityAI_0xCB_Tmain_boss_shittuki
// Made by beco
// Verison 1.0
...
#define Sub_8056200_EntityAI_0xCB_Tmain_boss_shittuki ((void (*)()) 0x8056201)

void TimeAttack_Sub_8056200_EntityAI_0xCB_Tmain_boss_shittuki() {
    // Custom code
	BossLife = CurrentEnemyData.CurEnemy_Life;

    // Vanilla code
    Sub_8056200_EntityAI_0xCB_Tmain_boss_shittuki();
}
