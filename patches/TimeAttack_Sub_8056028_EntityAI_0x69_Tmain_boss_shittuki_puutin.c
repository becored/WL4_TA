// @Description TimeAttack_Sub_8056028_EntityAI_0x69_Tmain_boss_shittuki_puutin
...
void TimeAttack_Sub_8056028_EntityAI_0x69_Tmain_boss_shittuki_puutin() {
    // Custom code
    switch (CurrentEnemyData.CurEnemy_CurrentAnimationId) {
        case Q_INITIAL2:
            ...
            break;
        default:
            if (!usWarStopFlg && ucTimeUp == 1 && CurrentEnemyData.CurEnemy_Life > 0){
                CountFlag = 1;
            }
            break;
    }
