...
#define testChar (*(volatile unsigned char*) 0x3007000)
#define testShort (*(volatile unsigned short*) 0x3007001)
...
void TimeAttack_Sub_8067A64_EntityAI_0xEC_Tmain_mouja_face() {
    // Custom code
    testChar = CurrentEnemyData.CurEnemy_CurrentAnimationId;
    testShort = CurrentEnemyData.CurEnemy_YPos;
